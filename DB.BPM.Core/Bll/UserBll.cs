...
namespace DB.BPM.Core.Bll
{
    public class UserBll
    {
        ...
        //根据角色ID获取本角色所有用户
        public string GetUsersByroleID(int rid)
        {
            return JSONhelper.ToJson(UserDal.Instance.GetUsersByrid(rid));
        }
        /// <summary>
        /// 判断用户名是否存在
        /// </summary>
        ...
        public string GetUsersByDempartmentID(int depid)
        {
            var users = UserDal.Instance.GetUsersByDepartmentID(depid);
