...
namespace DB.BPM.Admin.sys.ashx
{
    /// <summary>
    /// DicHandler 的摘要说明
    /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (rpm.Action)
            {
                ...
                case "del":
                    ...
                    break;
                case "getdictree":
                    var categoryId1 = PublicMethod.GetInt(rpm.Request("categoryId"));
                    string dicJson1 = DicBll.Instance.GetDicListBy(categoryId1);
                    context.Response.Write(dicJson1.Replace("KeyId", "id").Replace("Title", "text"));
