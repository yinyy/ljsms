...
var formHTML = '<form id=DBForm><table cellpadding=5 cellspacing=0 width=100% align="center" class="grid" border=0><tr><td align="right">\
...
function createParam(action, keyid) {
    var o = {};
    var query = top.$('#DBForm').serializeArray();
