<%@ Page Title="" Language="C#" MasterPageFile="../Site1.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="DB.BPM.Admin.sys.Users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="layout">
        <div region="west" iconCls="icon-chart_organisation" split="true" title="学院部门" style="width:220px;padding: 5px" collapsible="false">
            <ul id="deptree"></ul>
        </div>
        <div region="center" title="教职工帐号" iconCls="icon-users" style="padding: 2px; overflow: hidden">
            <div id="toolbar">
               <%=base.BuildToolbar() %>
