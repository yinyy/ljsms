...
function fillInvestigate(investigateId, teachCourseId) {
    var hDialog = top.jQuery.hDialog({
        title: '填写问卷', max: true,
        content: '<link href="../css/investigate.css?d=1" rel="stylesheet" /><div id="investigate_page"><div id="investigate_title"><p style="font-weight:bolder;">亲爱的同学们：</p><p style="text-indent:32px;line-height:24px;">为了详细了解我校教师的教育教学状况，以进一步完善学校为你提供的教育教学服务，学校教务处特研制了这份调查问卷，请你反复斟酌，以诚信、真实的态度把你认为合适的选项涂在信息卡上。不必具名，谢谢。</p></div><div id="investigate_range"></div></div>',
        iconCls: 'icon-add',
        submit: function () {
