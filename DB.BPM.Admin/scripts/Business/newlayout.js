...
var loginouturl ="ashx/loginout.ashx";
$(function () {
    if (menus) {
        initNav();
        tabClose();
        addTab('欢迎使用智慧校园综合信息平台', 'welcome.html', 'icon-house_star'); //添加默认TAB
    } else {
...
function initNav() {
    ...
    $('#tabs').tabs({
        tools: [{
            ...
            handler: function () {
                addTab('今天教师授课考勤信息公开', '/tm/desktop.aspx', 'icon-house_star');
                return false;
            }
        }, {
...
var str_editpass = '<form id="DB_Form"><table class="grid">';
