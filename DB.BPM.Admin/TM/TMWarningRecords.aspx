<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMWarningRecords.aspx.cs" Inherits="TM.WEB.TM.TMWarningRecords" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMWarningRecords.js"></script>
</asp:Content>
