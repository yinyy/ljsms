<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMBreakRules.aspx.cs" Inherits="TM.WEB.TM.TM.TMBreakRules" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMBreakRules.js"></script>
</asp:Content>
