<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMTeachCourse.aspx.cs" Inherits="TM.WEB.TM.TMTeachCourse" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMTeachCourse.js"></script>
</asp:Content>
