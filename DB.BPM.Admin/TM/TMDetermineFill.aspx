<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMDetermineFill.aspx.cs" Inherits="DB.BPM.Admin.TM.TMDetermineFill" %>
...
<!-- 工具栏按钮 -->
    ...
    <script src="js/DetermineOp.js?d=<%=DateTime.Now.Ticks %>"></script>
      <script src="js/TMDetermineFill.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
