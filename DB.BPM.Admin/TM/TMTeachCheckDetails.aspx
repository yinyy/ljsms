<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMTeachCheckDetails.aspx.cs" Inherits="TM.WEB.TM.TMTeachCheckDetails" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMTeachCheckDetails.js"></script>
</asp:Content>
