<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMTeachCheck.aspx.cs" Inherits="TM.WEB.TM.TMTeachCheck" %>
...
<!-- 工具栏按钮 -->
    <div id="toolbar"><%= base.BuildToolbar()%>【根据课程查询】:<select id="txt_CourseSelect" class="easyui-combogrid" >            
        </select>
    ...
    <!-- 引入js文件 -->
      <script src="js/TMTeachCheck.js"></script>
</asp:Content>
