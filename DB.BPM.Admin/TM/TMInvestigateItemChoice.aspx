<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMInvestigateItemChoice.aspx.cs" Inherits="DB.BPM.Admin.TM.TMInvestigateItemChoice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/dic.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMInvestigateItemChoice.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
