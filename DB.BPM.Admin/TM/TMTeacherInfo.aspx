<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMTeacherInfo.aspx.cs" Inherits="DB.BPM.Admin.TM.TMTeacherInfo" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMTeacherInfo.js"></script>
</asp:Content>
