<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMInvestigate.aspx.cs" Inherits="DB.BPM.Admin.TM.TMInvestigate" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMInvestigate.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
