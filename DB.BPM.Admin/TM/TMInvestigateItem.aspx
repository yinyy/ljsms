<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMInvestigateItem.aspx.cs" Inherits="DB.BPM.Admin.TM.TMInvestigateItem" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMInvestigateItem.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
