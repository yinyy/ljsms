<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMInvestigateFill.aspx.cs" Inherits="DB.BPM.Admin.TM.TMInvestigateFill" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/TMInvestigateFill.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
