<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TMDetermine.aspx.cs" Inherits="DB.BPM.Admin.TM.TMDetermine" %>
...
<!-- 工具栏按钮 -->
    ...
    <script src="js/TMDetermine.js?d=<%=DateTime.Now.Ticks %>"></script>
