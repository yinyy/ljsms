...
namespace DB.Common.Data
{
    public static class DbUtils
    {
        ...
        //                    if (count == 0)
        //                    {
        //                        cmd.CommandText = "insert " + TableConvention.Resolve(ee) + " ("
        //                        .InjectFrom(new FieldsBy().IgnoreFields("keyid"), ee) + ") values("
        //                        .InjectFrom(new FieldsBy().IgnoreFields("keyid").SetFormat("@{0}"), ee)
        //                        + ") select @@identity";
        //                    }

        //                    cmd.InjectFrom(new SetParamsValues().IgnoreFields("keyid"), ee);
